...
public class BiomeModifiersCommon {
    ...
    private static void init() {
        ...
        registerEntry("exosphere:default_decoration",
                List.of("exosphere:moss_ceiling", "exosphere:glow_berries", "exosphere:spore_blossom"));
        ...
        registerEntry("exosphere:ice_decoration",
                List.of("exosphere:ice_ceiling", "exosphere:snow_vines", "exosphere:blue_ice_vines", "exosphere:roots_lichen", "exosphere:glow_lichen_vines"));
